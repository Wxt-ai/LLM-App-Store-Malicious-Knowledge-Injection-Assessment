...
if __name__ == "__main__":
    ...
    root_folder_path = r"C:\Users\h1419\Desktop\测试图片\歧视"
    ...
    if not os.path.isdir(root_folder_path):
        ...
        if not image_paths_from_folders:
            ...
            print("开始处理图片并进行评分...")
            # 输出CSV文件名
            process_images_and_save_scores(image_paths_from_folders, r"C:\Users\h1419\Desktop\测试结果\image_reactionary_scores_doubao_prompt_scoring_qishi.csv")
